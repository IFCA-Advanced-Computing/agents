...
int main(int argc, char *argv[])
{
	...
	Analysis::AgentResults agentResults(simRecord, "agents.csv", "Vaca", ";");
	...
	agentResults.addAnalysis(new Analysis::AgentMean("abono"));
	agentResults.addAnalysis(new Analysis::AgentSum("abono"));
	agentResults.addAnalysis(new Analysis::AgentHDFtoSHP( "shp/agents.shp'", -1));

	agentResults.apply();

	Analysis::RasterResults rasterResults(simRecord, "rasters.csv", "abono", ";");
